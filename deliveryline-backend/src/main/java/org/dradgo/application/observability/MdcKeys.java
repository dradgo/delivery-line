 ...
 * Invariants. The five keys below are the ONLY MDC keys this codebase is permitted to stamp; the
...
public final class MdcKeys {
  ...
  public static final Set<String> ALL =
      Set.of(
          CORRELATION_ID, WORKFLOW_RUN_ID, RUNNER_EXECUTION_ID, ARTIFACT_ID, ARTIFACT_OPERATION_ID);
