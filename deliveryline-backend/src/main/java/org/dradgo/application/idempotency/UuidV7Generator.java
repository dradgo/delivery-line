...
public class UuidV7Generator {
  ...
  /**
   * Parse a supplied UUID string of any version, returning {@link Optional#empty()} when the value
   * is null, blank, longer than the canonical UUID length, or fails {@link UUID#fromString}
