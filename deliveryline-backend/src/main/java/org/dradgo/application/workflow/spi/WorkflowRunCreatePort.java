...
public interface WorkflowRunCreatePort {
	 ...
	 * and rely on the surrounding service to coordinate atomicity with related event-write calls.
	 *
	 ...
	 */
	WorkflowRunSnapshot create(String publicId, WorkflowState initialState);
}
