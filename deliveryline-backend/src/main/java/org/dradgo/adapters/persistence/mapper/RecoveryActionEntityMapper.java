...
/**
 * Entity ↔ application-shape translation for {@code recovery_actions} (story 1.18 Task 2).
 * Explicit (no MapStruct) to match the convention established by sibling persistence mappers.
 */
@Component
