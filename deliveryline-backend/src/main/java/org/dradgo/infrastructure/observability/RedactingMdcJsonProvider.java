 ...
 * through {@link RedactionLayoutHolder}. Replaces the default {@code <mdc>} provider so MDC values
 * stamped by code paths that bypass {@code MdcKeys.sanitizeForLog} (e.g., third-party libraries)
 * cannot leak unredacted content into JSON output. See D2 of the story 1.19 review.
 */
