 ...
 * fully-rendered stack trace through {@link RedactionLayoutHolder}. Replaces the default {@code
 * <stackTrace>} provider so throwable messages cannot leak credentials, bearer tokens, or JDBC URLs
 * into JSON output. See D2 of the story 1.19 review.
 */
