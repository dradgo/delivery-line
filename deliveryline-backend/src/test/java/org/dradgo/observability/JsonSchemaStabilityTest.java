...
/**
 * Story 1.19 AC10: under the {@code demo} profile, every JSON-encoded log line MUST parse as valid
 * JSON with the documented stable field set ({@code level}, {@code logger}, {@code thread}, {@code
 * message}, {@code mdc}, optional {@code stack_trace}).
 *
 * <p>Programmatically wires the logstash composite encoder that mirrors the {@code demo} block of
 * {@code logback-spring.xml}, captures the encoded bytes, and asserts the shape.
 */
