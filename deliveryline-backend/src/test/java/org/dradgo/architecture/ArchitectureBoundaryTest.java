...
class ArchitectureBoundaryTest {
	...
	@ArchTest
	static final ArchRule layered_boundaries = ArchitectureRuleCatalog.LAYERED_BOUNDARIES;

	@ArchTest
	static final ArchRule adapter_package_layout = ArchitectureRuleCatalog.ADAPTER_PACKAGE_LAYOUT;

	@ArchTest
	static final ArchRule domain_package_must_exist = ArchitectureRuleCatalog.DOMAIN_PACKAGE_MUST_EXIST;

	@ArchTest
	static final ArchRule application_package_must_exist = ArchitectureRuleCatalog.APPLICATION_PACKAGE_MUST_EXIST;

	@ArchTest
	static final ArchRule adapters_package_must_exist = ArchitectureRuleCatalog.ADAPTERS_PACKAGE_MUST_EXIST;
