...
class ProblemDetailsCorrelationIdContractTest {
	...
	void setUp() {
		...
		when(objectMapperProvider.getIfAvailable(org.mockito.ArgumentMatchers.<java.util.function.Supplier<ObjectMapper>>any()))
	...
	void problemDetailsIncludesCorrelationIdFromMdc() {
		...
		DomainException error = new DomainException(
