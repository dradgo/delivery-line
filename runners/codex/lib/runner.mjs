...
// label is which credential MODE was used, attributable but secret-free. Lock-step with
// runners/claude/lib/runner.mjs (only the provider token + label values differ).
const CODEX_AUTH_LABELS = {
  CODEX_AUTH_JSON: 'codex:subscription',
  CODEX_API_KEY: 'codex:api',
  OPENAI_API_KEY: 'codex:api',
};

function resolveAccountLabel(authVar) {
  return CODEX_AUTH_LABELS[authVar] ?? 'codex:unknown';
}
