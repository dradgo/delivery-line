...
// artifacts/…/spec.md", so Codex opened that path relative to /workspace/repo, failed, reported
...
//
// Twin of runners/claude/test/runner-spec-reference-path.test.mjs (only provider text differs).
...
function prepare() {
  ...
  const promptPath = join(dir, 'codex.prompt');
  writeFileSync(
    bundlePath,
    JSON.stringify({
      schemaVersion: 1,
